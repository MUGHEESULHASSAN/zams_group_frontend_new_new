...
const TaxItemsManagement = () => {
  ...
  const [taxItems, setTaxItems] = useState([
    ...
    { id: 3, name: "GST 18%", description: "GST 18%", rate: "18", availableOn: "Both", taxType: "GST" },
    { id: 4, name: "GST 17%", description: "GST 17%", rate: "17", availableOn: "Both", taxType: "GST" },
    { id: 5, name: "WHT 4%", description: "WHT 4%", rate: "4", availableOn: "Purchase", taxType: "Withholding Tax" },
  ])
...
export default TaxItemsManagement
